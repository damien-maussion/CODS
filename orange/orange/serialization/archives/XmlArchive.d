...
final class XmlArchive (U = char) : ArchiveBase!(U)
{
	...
	//+++
	void unarchiveObject (string key, out Id id, out Object result, ClassInfo[] registeredTypes, void delegate () dg)
	///////////////////////////////////////////
	{
		restore(lastElement) in {
			...
			//+++
			if(result is null) {
			  foreach(ClassInfo ci; registeredTypes) {
			    if(ci.name == name) {
			      result = newInstance(ci);
			    }
			  }
			}
			///////////////////////////////////////////
